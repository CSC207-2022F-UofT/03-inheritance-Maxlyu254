...
public class CrossbodyBag extends Bag {
    ...
    /**
     * A constructor that takes three arguments: the bag's color, capacity, and number of straps.
     *
     * @param color a String representing the Bag's color
     *
     * @param capacity an int representing the Bag's capacity
     *
     * @param numberOfStraps an int representing the Bag's number of Straps.
     */
